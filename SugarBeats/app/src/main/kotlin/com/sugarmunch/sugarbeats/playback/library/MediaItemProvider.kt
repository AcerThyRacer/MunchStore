package com.sugarmunch.sugarbeats.playback.library
...
import com.sugarmunch.sugarbeats.helpers.TAB_GENRES
import com.sugarmunch.sugarbeats.helpers.TAB_PLAYLISTS
import com.sugarmunch.sugarbeats.helpers.TAB_TRACKS
import com.sugarmunch.sugarbeats.models.QueueItem
import com.sugarmunch.sugarbeats.models.toMediaItems
...
internal class MediaItemProvider(private val context: Context) {
    ...
    private fun buildRoot() {
        val root = buildMediaItem(
            title = context.getString(org.fossify.commons.R.string.root),
            mediaId = SMP_ROOT_ID,
